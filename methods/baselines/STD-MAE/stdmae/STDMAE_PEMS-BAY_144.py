...
CFG.MODEL.PARAM = {
    ...
    "pre_trained_tmae_path": "mask_save/TMAE_PEMS04_864.pt",  # 使用 PEMS04 的预训练模型
    "pre_trained_smae_path": "mask_save/SMAE_PEMS04_864.pt",  # 使用 PEMS04 的预训练模型
    "mask_args": {
                    "patch_size":12,
                    "in_channel":1,
                    "embed_dim":96,
...
CFG.TRAIN.CL.PREDICTION_LENGTH = 144
...
# ================= evaluation ================= #
# Evaluate at horizons 1-144 and average
CFG.TEST.EVALUATION_HORIZONS = list(range(1, 145))  # 1 to 144
