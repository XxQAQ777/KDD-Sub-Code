...
def generate_data(args: argparse.Namespace):
    ...
    PEMS-BAY dataset with 144->144 configuration:
        - Normalization method: standard norm.
        - Dataset division: 7:1:2.
        - Window size: history 144, future 144.
        - Channels (features): three channels [traffic speed, time of day, day of week]
        - Target: predict the traffic speed of the future 144 time steps.
...
if __name__ == "__main__":
    ...
    DATA_FILE_PATH = "/home/xiaoxiao/FlowGNN/STG4Traffic-main/TrafficSpeed/data/PEMS-BAY/pems-bay.h5"
    GRAPH_FILE_PATH = "/home/xiaoxiao/FlowGNN/STG4Traffic-main/TrafficSpeed/data/PEMS-BAY/processed/adj_mx_bay.pkl"
