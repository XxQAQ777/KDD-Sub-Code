...
args.add_argument('--gcn_depth', default=config['model']['gcn_depth'], type=int)
args.add_argument('--dropout', default=config['model']['dropout'], type=float)
args.add_argument('--subgraph_size', default=config['model']['subgraph_size'], type=int)
args.add_argument('--node_dim', default=config['model']['node_dim'], type=int)
args.add_argument('--tanhalpha', default=config['model']['tanhalpha'], type=int)
args.add_argument('--cl_decay_steps', default=config['model']['cl_decay_steps'], type=int)
args.add_argument('--hyperGNN_dim', default=config['model']['hyperGNN_dim'], type=int)
