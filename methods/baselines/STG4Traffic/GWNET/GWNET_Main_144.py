...
def load_data(args):
    data_loader = load_dataset(args.dataset_dir, args.batch_size, args.batch_size, 1)
...
def generate_model_components(args, supports):
    supports = [torch.tensor(adj).to(args.device) for adj in supports]
    # 1. model
    model = Network(
        args.device,
...
if __name__ == '__main__':
    ...
    if args.mode == "train":
        ...
        checkpoint = "../log/GWNET/METRLA_144/BEST_MODEL_PATH.pth"
