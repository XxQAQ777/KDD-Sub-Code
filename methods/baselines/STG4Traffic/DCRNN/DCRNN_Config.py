...
DEVICE = 'cuda:1'
MODEL = 'DCRNN'
DATASET = 'PEMSBAY'  # PEMSBAY or METRLA
...
args.add_argument('--num_rnn_layers', default=config['model']['num_rnn_layers'], type=int)
args.add_argument('--max_diffusion_step', default=config['model']['max_diffusion_step'], type=int)
